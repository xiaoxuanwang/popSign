...
//        Destroy(splash, 2f);
		...
		//POPSign commented out scoring so that score doesn't increment when items fall in buckets.
		mainscript.Instance.PopupScore( score * mainscript.doubleScore, transform.position + new Vector3(0, 2, 0));
    }
