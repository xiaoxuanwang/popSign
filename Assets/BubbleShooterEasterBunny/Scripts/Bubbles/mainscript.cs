...
//		arcadeMode = InitScript.Arcade;
    ...
    public void PopupScore(int value, Vector3 pos)
    {
		...
		poptxt.transform.GetComponentInChildren<Text> ().font = (Font) Resources.Load("Typo_Round_Regular_Demo", typeof(Font));
		poptxt.transform.GetComponentInChildren<Text> ().color = new Color (64.0f / 255.0f, 187.0f / 255.0f, 180.0f / 255.0f, 1.0f);
	...
	void Update () {
        ...
        {
			//Debug.Log ("Destroy the alone ball in mainscript");
